...
const Business = () => {
  ...
  <div className='text-black border-Newsblue border-2 mt-3 bg-white rounded-lg' key={t.id}>
    <h1 className='font-bold text-3xl pt-2'>News of the Economy!</h1>
    ...
    <img className='m-auto mb-4 mt-4' src={'http://127.0.0.1:8090/api/files/business/'+ t.id + '/' + t.image1} alt="" />
