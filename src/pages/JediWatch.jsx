...
const JediWatch = () => {
  ...
  useEffect(() => {
    makeRequest("http://127.0.0.1:8090/api/collections/jediwatch/records")
  }, [])
  ...
  <div className='text-black border-Newsblue border-2 mt-3 bg-white rounded-lg' key={t.id}>
    <h1 className='font-bold text-3xl pt-2'>Jedi Watch News!</h1>
    ...
    <img className='m-auto mb-4 mt-4' src={'http://127.0.0.1:8090/api/files/jediwatch/'+ t.id + '/' + t.image1} alt="" />
