...
const Sports = () => {
  ...
  <div className='mt-3 text-black bg-white border-2 rounded-lg border-Newsblue' key={t.id}>
    <h1 className='pt-2 text-3xl font-bold'>Sports of the Republic!</h1>
    ...
    <img className='m-auto mt-4 mb-4' src={'http://127.0.0.1:8090/api/files/sports/'+ t.id + '/' + t.image1} alt="" />
